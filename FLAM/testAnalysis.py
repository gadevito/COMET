...
class COMET(BaseEstimator):
    ...
    def score(self, X, y):
        ...
        score = str(r1['f'])
        _logger = logger._logger #.getLogger("COSMIC_ANALYSIS")
...
def main():
    ...
    param_grid = {'temperature': [0.4, 0.3, 0.2, 0.1, 0.0],  
              'max_tokens': [1100], 
              'model':['gpt-4'],
              'top_p': [1],
    ...
    for i in range(1,5):
        ...
        filename = "./test_set/cosmic_analysis/"+str(i)+"_Prompt.txt"
        ...
        filename = "./test_set/cosmic_analysis/"+str(i)+"_Solution.txt"
        file = open(filename, 'r')
        uc1Sol = file.read()
        file.close()
