...
model_out = [ 
#1
["Remove line command","Line status","Line status","Remove line command","Line status"
],
#2
["Restore line command","Line status","Line status","Restore line command","Line status"
],
#3
["Switch command","Line status","Line status","Switch command","Line status"
],
#4
["Switch command","Line status","Line status","Switch command","Line status"
],
#5
["Line failed command","Line status","Line status","Line switch command","Line status"
],
#6
["Line degraded command","Line status","Line status","Line switch command","Line status"
],
#7
["Line cleared command","Line status","Line status","Line switch command","Line status"
]
]
...
#5
[
"Line failed signal","Line status","Line status","Line switch command","Line status"
],
#6
["Line degraded signal","Line status","Line status","Line switch command","Line status"
],
#7
["Line cleared signal","Line status","Line status","Line switch command","Line status"
]
