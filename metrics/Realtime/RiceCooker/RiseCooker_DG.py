...
model_out = [ 
#1
["Start signal","Turn ON signal","Turn ON signal"
],
#2
["Clock tick","Elapsed time signal","Cooking mode","Target temperature","Target temperature"
],
#3
["Clock tick","Target temperature","Actual temperature","None","Heater command"
]
]
