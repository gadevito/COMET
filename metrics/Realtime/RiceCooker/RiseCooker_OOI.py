...
model_out = [ 
#1
["System","Heater","Cooking Lamp"
],
#2
["Clock","Clock","Current settings","Target settings","Target settings"
],
#3
["Clock","Temperature","Temperature","None","Heater"
]
...
reference = [
#1
["Start Button","Heater","Cooking Lamp"
],
#2
["Timer","Timer","Current settings","Target settings","Target settings"
],
#3
["Timer","Cooking current settings","Temperature Sensor","None","Heater"
]
]
